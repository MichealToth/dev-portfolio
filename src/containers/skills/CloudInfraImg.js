...
"
				...
				<path
					...
					fill="#F0EFF4"
				/>
				<circle cx="145.85129" cy="470.70682" r="6" fill="#F0EFF4" />
				<circle cx="166.85129" cy="470.70682" r="6" fill="#F0EFF4" />
				<circle cx="187.85129" cy="470.70682" r="6" fill="#F0EFF4" />
				<path
...
"
				...
				<rect
					...
					fill="#F0EFF4"
				/>
				<circle cx="264.85129" cy="269.70682" r="14" fill="#F0EFF4" />
				<circle cx="997.85129" cy="271.70682" r="11" fill="#F0EFF4" />
				<circle cx="1051.85129" cy="492.70682" r="11" fill="#F0EFF4" />
				<circle cx="321.85129" cy="492.70682" r="11" fill="#F0EFF4" />
			</svg>
		);
	}
}
